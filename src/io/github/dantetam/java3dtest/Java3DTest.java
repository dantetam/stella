...
package io.github.dantetam.java3dtest;
...
public class Java3DTest extends JFrame {
    ...
    private static String fileName = "data/models/miranda/ME3_360_CHARACTER_Miranda_Lawson.obj";
     ...
     */
    public Java3DTest() throws IOException {
        configureWindow();
        configureCanvas();
        conigureUniverse();
        addModelToUniverse();
    ...
    private void addModelToUniverse() throws IOException {
        Scene scene = getSceneFromFile(fileName); 
